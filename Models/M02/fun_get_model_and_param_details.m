...
% Both IB and DB
LHS_SUB  = 500; % Number of LHS subsamples to use fmincon on
% LHS_B = 6;
...
prms_est(5) = false;   % k_3off [05]; k5on and k5off known
prms_est(8:9) = false; % k_5on  [08]; k_5off [09];
 
%%%%%% ZERO OUT REACTIONS
prms_rem = false(1,16);
prms_rem([8:9 12:13]) = true; % Reaction 5 and 7 equals zero
